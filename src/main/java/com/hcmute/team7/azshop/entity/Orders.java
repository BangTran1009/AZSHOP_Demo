...
public class Orders {
    ...
    @Column(name = "amountFromUser", nullable = false)
    private Double amountFromUser;
    @Column(name = "amountFromStore", nullable = false)
    private Double amountFromStore;
    @Column(name = "amountToStore", nullable = false)
    private Double amountToStore;
    @Column(name = "amountToGD", nullable = false)
